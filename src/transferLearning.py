...
# Split original training set into train/test/val set
split_folders.ratio('datasets', output="output_split", seed=1337, ratio=(.7, .15, .15)) # 70% training, 15% validation, 15% training

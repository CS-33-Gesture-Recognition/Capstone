...
outputcolor = open('singleimagecolor', 'w+')
...
outputdepth.write("Outputting Depth Image\n")
outputdepth.write("Size of depth image: " + str(depth_image.size) + " \n")
for i in depth_image:
    outputdepth.write(str(i[0]) + "," + str(i[1]) + "," + str(i[2]) + "\n")

#Writing color image to file
outputcolor.write("Outputting Color Image\n")
outputcolor.write("Size of color image: " + str(color_image.size) + " \n")
for i in color_image:
    outputcolor.write(str(i[0]) + "," + str(i[1]) + "," + str(i[2]) + "\n")
